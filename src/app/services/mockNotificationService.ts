  ...
  return [
    {
      ...
      message: 'MIMIR monitoring systems are operating normally',
      type: 'info',
    ...
    },
    {
      ...
      message: 'Scheduled maintenance for MIMIR will begin at 2:00 AM EST',
      type: 'warning',
...
export const getDemoNotifications = () => {
  return {
    notification15s: {
      title: 'MIMIR Infrastructure Alert',
    ...
    notification30s: {
      title: 'MIMIR Performance Update',
    ...
    notification45s: {
      title: 'MIMIR Maintenance Notice',
