...
const APP_FAVICONS: Record<string, string> = {
  'MIMIR': '/icons/favicons/mimir.ico',
};

const DEFAULT_FAVICON = '/icons/favicons/mimir.ico';
...
const AppContent: React.FC<AppWrapperProps> = ({ children }) => {
  ...
  useEffect(() => {
    document.title = APP_TITLES['MIMIR'] || 'MIMIR | UI Demo';
    updateFavicon(APP_FAVICONS['MIMIR'] || DEFAULT_FAVICON);
  }, []);
